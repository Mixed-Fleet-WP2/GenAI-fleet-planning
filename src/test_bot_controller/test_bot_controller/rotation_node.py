...
from movement_interface.srv import MovementSuccess
import threading
...
class RotationNode(Node):
    def __init__(self):
        ...
        self.create_subscription(Empty, "/pick", partial(self.handle_command, topic_name='/pick'), 10)
        #self.srv = self.create_service(MovementSuccess, "move", partial(self.handle_service_command, name="/pick"))  # CHANGE
    ...
    def move(self):
        self.get_logger().info("ALSO GOT HERE")
