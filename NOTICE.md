...
It includes components licensed under the Apache License 2.0:
  - Package: nav2_launch
It includes components licensed under the Creative Commons Attribution 4.0 International
 - Models inside drone_cpp package

## Third-Party Licenses

This project uses the following third-party software and code.  
Below are the license details and references for each dependency:

- **ROS 2**  
  Source: https://github.com/ros2/ros2  
  License: Apache License 2.0, BSD  
  License text: Refer to package-specific license files in the repository.
...
- **Navigation2 (Nav2)**  
  ...
  License: Apache License 2.0, LGPL-2.1-or-later, BSD-3-Clause  
  License text: Refer to package-specific license files in the repository.
